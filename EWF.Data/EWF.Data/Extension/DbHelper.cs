...
namespace EWF.Data
{
    ...
    public class DbHelper
    {
        ...
        /// 构造方法
        /// </summary>
        public DbHelper(IDbConnection _dbConnection)
        {
        ...
        private void PrepareCommand(IDbConnection conn, IDbCommand cmd, DbTransaction isOpenTrans, CommandType cmdType, string cmdText, params DbParameter[] dbParameter)
        {
