...
{
    public interface ISTATIONINFO_SCHEMEService : IDependency
    {
        Page<STATIONINFO_SCHEME> GetPageData(int pageIndex, int pageSize, string name);
        int Count(string STCD);
        STATIONINFO_SCHEME Get(Int32 ID);
        bool Insert(STATIONINFO_SCHEME entity);
        bool Update(STATIONINFO_SCHEME entity);
