...
*┌──────────────────────────────────────────────────────────────┐
*│　命名空间： EWF.IServices                                   
*│　接口名称： ISTATIONINFO_SHOWRepository                                      
*└──────────────────────────────────────────────────────────────┘
*/
using EWF.Entity;
using EWF.Util;
...
{
    public interface ISTATIONINFO_SHOWService : IDependency
    {
        Page<STATIONINFO_SHOW> GetPageData(int pageIndex, int pageSize, string name);
        int Count(string STCD);
        STATIONINFO_SHOW Get(Int32 ID);
        int Insert(STATIONINFO_SHOW entity);
        bool Update(STATIONINFO_SHOW entity);
