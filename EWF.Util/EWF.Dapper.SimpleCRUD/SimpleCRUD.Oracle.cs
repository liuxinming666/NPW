 ...
 * 版  权：亿水泰科（EWater）
 * 创建人：zhujun
 * 日  期：2019/2/26 19:23:29
 * 描  述：OracleSimpleCRUD
 * *********************************************/
using System;
...
{
    /// <summary>
    ///Oracle for Dapper.SimpleCRUD extensions
    /// </summary>
    public static partial class SimpleCRUD
    {
        ...
        /// <summary>
        /// Sets the database dialect to Oracle
        /// </summary>
        public static void SetDialectForOracle()
        {
        ...
        public static T Get_Oracle<T>(this IDbConnection connection, object id, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            if (_dialect == Dialect.Oracle)
                sb = sb.Replace("@", _parameterPrefix);
        ...
        public static IEnumerable<T> GetList_Oracle<T>(this IDbConnection connection, object whereConditions, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var idProps = GetIdProperties(currenttype).ToList();
            if (!idProps.Any())
        ...
        public static IEnumerable<T> GetList_Oracle<T>(this IDbConnection connection)
        {
            return connection.GetList_Oracle<T>(new { });
        }
        ...
        public static int? Insert_Oracle<TEntity>(this IDbConnection connection, TEntity entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            return Insert_Oracle<int?, TEntity>(connection, entityToInsert, transaction, commandTimeout);
        }
        ...
        public static TKey Insert_Oracle<TKey, TEntity>(this IDbConnection connection, TEntity entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public static int Update_Oracle<TEntity>(this IDbConnection connection, TEntity entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public static int Delete_Oracle<T>(this IDbConnection connection, T entityToDelete, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>The number of records affected</returns>
        public static int Delete_Oracle<T>(this IDbConnection connection, object id, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var idProps = GetIdProperties(currenttype).ToList();
        ...
        /// <param name="commandTimeout"></param>
        /// <returns>The number of records affected</returns>
        public static int DeleteList_Oracle<T>(this IDbConnection connection, object whereConditions, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public static int RecordCount_Oracle<T>(this IDbConnection connection, object whereConditions, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var currenttype = typeof(T);
            var name = GetTableName(currenttype);
